...
// NOTE: this segfault occurs when calling File::getSpecialLocation() statically
...
namespace APP
{
//   static const String StaticSeparator = File::separatorString ; // segfault here

  static const File VIDEOS_DIR = File::getSpecialLocation(File::userMoviesDirectory) ; // segfault here
}

int main (int argc, char* argv[])
{
//   String stack_separator = File::separatorString ; // separatorString is valid here

//   static const File VIDEOS_DIR = File::getSpecialLocation(File::userMoviesDirectory) ; // OK here
